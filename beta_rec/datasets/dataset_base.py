...
class DatasetBase(object):
    ...
    def load_leave_one_out(self, random=False, n_negative=100, test_copy=10):
        ...
        valid_data = get_dataframe_from_npz(valid_file)

        test_file = os.path.join(processed_leave_one_out_path, "test_0.npz")
        test_data = get_dataframe_from_npz(test_file)
    ...
    def load_random_split(self, test_rate=0.1, random=False, n_negative=100, by_user=False, test_copy=10):
    ...
    def load_random_basket_split(self, test_rate=0.1, random=False, n_negative=100, by_user=False, test_copy=10):
    ...
    def load_temporal_split(self, test_rate=0.1, n_negative=100, by_user=False, test_copy=10):
    ...
    def load_temporal_basket_split(self, test_rate=0.1, n_negative=100, by_user=False, test_copy=10):
